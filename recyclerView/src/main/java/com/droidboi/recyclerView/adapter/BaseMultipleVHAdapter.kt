package com.droidboi.recyclerView.adapter
 ...
 * any n-General Purpose Multiple Multiple [RecyclerView.ViewHolder] Adapter.
 *
...
abstract class BaseMultipleVHAdapter<Model> : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
	...
	/**
	 * Reference of [List] of [Model] as the immutable version of [list].
	 */
	val immutableList: List<Model>
		get() = list
	 ...
	 * and notifies the change in [list] to this [BaseMultipleVHAdapter].
	 *
	...
	/**
	 * Clears the [list] and notifies the change in the [list] to this [BaseMultipleVHAdapter].
	 */
	fun clearAllItems() {
